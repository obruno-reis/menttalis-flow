...
/**
 * Google Material Symbols "settings" (outlined, weight 400).
 * The path is inlined rather than pulled from the icon font so the app keeps
 * working offline as a PWA and costs no extra request for a single glyph.
 */
...
/** Instagram glyph, drawn to match the stroke weight of the surrounding UI. */
